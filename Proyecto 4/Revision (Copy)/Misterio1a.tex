...
\end{center}
\section{Problem: Misterio1a}
The problem inputted by the user is called \textquotedblleft Misterio1a\textquotedblright and consists of maximizing the following fuction:
...
\subsection{Pivot Table}\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        ...
        \hline
        \hline
        $1.000$& 0.000& -2.000& 0.000& 1.000& 1.000\\
        \hline
        0.000& \cellcolor{LightPink}$0.000$ & 0.000& 1.000& 1.000& 2.000& $Invalid$ \\
        \hline
        0.000& \cellcolor{KirbyPink}$1.000$ & -1.000& 0.000& 1.000& 1.000& \cellcolor{KirbyPink}$1.000$ \\
        \hline
    \end{tabular}
\end{adjustbox}
...
\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        ...
        $1.000$& 0.000& -2.000& 0.000& 1.000& 1.000\\
        \hline
        0.000& 0.000& \cellcolor{LightPink}$0.000$ & 1.000& 1.000& 2.000& $Invalid$ \\
        \hline
        0.000& 1.000& \cellcolor{LightPink}$-1.000$ & 0.000& 1.000& 1.000& $Invalid$ \\
        \hline
    \end{tabular}
\end{adjustbox}
