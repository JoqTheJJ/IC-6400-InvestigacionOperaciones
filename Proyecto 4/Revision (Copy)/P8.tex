...
\end{center}
\section{Problem: P8}
The problem inputted by the user is called \textquotedblleft P8\textquotedblright and consists of maximizing the following fuction:

$Z = x1 \cdot 36.000000 + x2 \cdot 30.000000 + x3 \cdot -3.000000 + x4 \cdot -4.000000$


Subject to:


$x1 \cdot 1.000000 + x2 \cdot 1.000000 + x3 \cdot -1.000000 + x4 \cdot 0.000000 \leq 5.000000$

$x1 \cdot 6.000000 + x2 \cdot 5.000000 + x3 \cdot 0.000000 + x4 \cdot -1.000000 \leq 10.000000$
...
\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
        \hline
        Z  & $x1$ & $x2$ & $x3$ & $x4$ & $S_1$ & $S_2$ & b\\
        \hline
        \hline
        1.000& -36.000& -30.000& 3.000& 4.000& 0.000& 0.000& 0.000\\
        \hline
        0.000& 1.000& 1.000& -1.000& 0.000& 1.000& 0.000& 5.000\\
        \hline
        0.000& 6.000& 5.000& 0.000& -1.000& 0.000& 1.000& 10.000\\
        \hline
    \end{tabular}
\end{adjustbox}
...
\subsection{Pivot Table}\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
        \hline
        Z  & $x1$ & $x2$ & $x3$ & $x4$ & $S_1$ & $S_2$ & b & Fractions\\
        \hline
        \hline
        $1.000$& 0.000& -0.000& 3.000& -2.000& 0.000& 6.000& 60.000\\
        \hline
        0.000& \cellcolor{LightPink}$0.000$ & 0.167& -1.000& 0.167& 1.000& -0.167& 3.333& $5.000$ \\
        \hline
        0.000& \cellcolor{KirbyPink}$1.000$ & 0.833& 0.000& -0.167& 0.000& 0.167& 1.667& \cellcolor{KirbyPink}$1.667$ \\
        \hline
    \end{tabular}
\end{adjustbox}
...
\subsection{Pivot Table}\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
        ...
        \hline
        \hline
        $1.000$& 0.000& 2.000& -9.000& 0.000& 12.000& 4.000& 100.000\\
        \hline
        0.000& 0.000& 1.000& -6.000& \cellcolor{KirbyPink}$1.000$ & 6.000& -1.000& 20.000& \cellcolor{KirbyPink}$20.000$ \\
        \hline
        0.000& 1.000& 1.000& -1.000& \cellcolor{LightPink}$0.000$ & 1.000& 0.000& 5.000& $Invalid$ \\
        \hline
    \end{tabular}
\end{adjustbox}
...
In this case it is found in the column 3 where there are no valid fractions:\\
\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
        \hline
        Z  & $x1$ & $x2$ & $x3$ & $x4$ & $S_1$ & $S_2$ & b & Fractions\\
        ...
        $1.000$& 0.000& 2.000& -9.000& 0.000& 12.000& 4.000& 100.000\\
        \hline
        0.000& 0.000& 1.000& \cellcolor{LightPink}$-6.000$ & 1.000& 6.000& -1.000& 20.000& $Invalid$ \\
        \hline
        0.000& 1.000& 1.000& \cellcolor{LightPink}$-1.000$ & 0.000& 1.000& 0.000& 5.000& $Invalid$ \\
        \hline
    \end{tabular}
\end{adjustbox}
