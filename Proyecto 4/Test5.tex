...
\end{center}
\section{Problem: Test5}
The problem inputted by the user is called \textquotedblleft Test5\textquotedblright and consists of maximizing the following fuction:
