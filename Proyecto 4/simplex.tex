...
\end{center}
\section{Problem: Multiples v2}
The problem inputted by the user is called \textquotedblleft Multiples v2\textquotedblright and consists of maximizing the following fuction:

$Z = x1 \cdot 4.000000 + x2 \cdot 14.000000$


Subject to:


$x1 \cdot 2.000000 + x2 \cdot 7.000000 \leq 21.000000$

$x1 \cdot 7.000000 + x2 \cdot 2.000000 \leq 21.000000$
...
\subsection{Pivot Table}\begin{center}
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        ...
        \hline
        \hline
        1.000& 0.000& \cellcolor{LightPink}$0.000$ & 2.000& 0.000& 42.000& 0.000\\
        \hline
        0.000& 0.286& \cellcolor{KirbyPink}$1.000$ & 0.143& 0.000& 3.000& \cellcolor{KirbyPink}$3.000$ \\
        \hline
        0.000& 6.429& \cellcolor{LightPink}$0.000$ & -0.286& 1.000& 15.000& $10.500$ \\
        \hline
    \end{tabular}
\end{center}
...
\alpha \cdot 
\begin{bmatrix}
x1 = 0.00 \\ x2 = 3.00 \\ \end{bmatrix}
+ (1 - \alpha) \cdot 
\begin{bmatrix}
x1 = 2.33 \\ x2 = 2.33 \\  \end{bmatrix}
$$
...
The final result of maximizing  the given function is 42.000 as a result of setting the variables to the values: 
