...
\end{center}
\section{Problem: Test4}
The problem inputted by the user is called \textquotedblleft Test4\textquotedblright and consists of minimizing the following fuction:
