...
\begin{tikzpicture}
 ...
 \Vertex[x=8, y=0, color=LightPink, size=0.5, label=$Washington$]{E}
 
 \Edge[bend=-30, label=$16$, Direct](A)(C) 
 \Edge[bend=-30, label=$17$, Direct](A)(D) 
 \Edge[bend=-30, label=$5$, Direct](A)(E) 
 \Edge[bend=-30, label=$2$, Direct](B)(A) 
 \Edge[bend=-30, label=$2$, Direct](B)(D) 
 \Edge[bend=-30, label=$3$, Direct](B)(E) 
 \Edge[bend=-30, label=$15$, Direct](C)(A) 
 \Edge[bend=-30, label=$1$, Direct](C)(B) 
 \Edge[bend=-30, label=$6$, Direct](C)(D) 
 \Edge[bend=-30, label=$9$, Direct](D)(B) 
 \Edge[bend=-30, label=$5$, Direct](D)(C) 
 \Edge[bend=-30, label=$11$, Direct](D)(E) 
 \Edge[bend=-30, label=$9$, Direct](E)(A) 
 \Edge[bend=-30, label=$2$, Direct](E)(B) 
 \Edge[bend=-30, label=$8$, Direct](E)(C)\end{tikzpicture}
\end{center}
\section{Table $D_{0}$}
\begin{center}
...
\begin{tikzpicture}
 ...
 \Edge[bend=-30, label=$13$, Direct](A)(C) 
 \Edge[bend=-30, label=$9$, Direct](A)(D) 
 \Edge[bend=-30, label=$5$, Direct](A)(E) 
 \Edge[bend=-30, label=$2$, Direct](B)(A) 
 ...
 \Edge[bend=-30, label=$1$, Direct](C)(B) 
 \Edge[bend=-30, label=$3$, Direct](C)(D) 
 \Edge[bend=-30, label=$4$, Direct](C)(E) 
 \Edge[bend=-30, label=$8$, Direct](D)(A) 
 \Edge[bend=-30, label=$6$, Direct](D)(B) 
 \Edge[bend=-30, label=$5$, Direct](D)(C) 
 \Edge[bend=-30, label=$9$, Direct](D)(E) 
 \Edge[bend=-30, label=$4$, Direct](E)(A) 
 \Edge[bend=-30, label=$2$, Direct](E)(B) 
 \Edge[bend=-30, label=$8$, Direct](E)(C) 
 \Edge[bend=-30, label=$4$, Direct](E)(D)\end{tikzpicture}
\end{center}
\end{document}
