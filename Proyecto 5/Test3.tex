...
\end{center}
\section{Problem: Test3}
The problem inputted by the user is called \textquotedblleft Test3\textquotedblright and consists of maximizing the following fuction:

$Z = x1 \cdot -3.000000 + x2 \cdot 6.000000$


Subject to:


$x1 \cdot 5.000000 + x2 \cdot 7.000000 \leq 35.000000$
...
\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|}
        ...
        \hline
        0.000& 5.000& 7.000& 1.000& 0.000& 35.000\\
        \hline
...
\subsection{Pivot Table}\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        \hline
        Z  & $x1$ & $x2$ & $s1$ & $s2$ & b & Fractions\\
        \hline
        \hline
        $0.000$& 0.000& 0.000& 0.000& 3.000& 6.000\\
        \hline
        0.000& 8.500& \cellcolor{LightPink}$0.000$ & 1.000& -3.500& 28.000& $5.000$ \\
        \hline
        0.000& -0.500& \cellcolor{KirbyPink}$1.000$ & 0.000& 0.500& 1.000& \cellcolor{KirbyPink}$1.000$ \\
        \hline
    \end{tabular}
\end{adjustbox}
...
\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|}
        ...
        0.000& 0.000& 0.000& 0.000& 3.000& 6.000\\
        \hline
        0.000& 8.500& 0.000& 1.000& -3.500& 28.000\\
        \hline
...
\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|}
        ...
        0.000& 0.000& 0.000& 0.000& 3.000& 6.000\\
        \hline
        0.000& 1.000& 0.000& 0.118& -0.412& 3.294\\
        \hline
        0.000& 0.000& 1.000& 0.059& 0.294& 2.647\\
        \hline
    \end{tabular}
\end{adjustbox}
...
\alpha \cdot 
\begin{bmatrix}
x1 = 0.00 \\ x2 = 1.00 \\ \end{bmatrix}
+ (1 - \alpha) \cdot 
\begin{bmatrix}
x1 = 3.29 \\ x2 = 2.65 \\  \end{bmatrix}
$$
...
The final result of maximizing  the given function is 6.000 as a result of setting the variables to the values: 
