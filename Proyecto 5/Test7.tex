...
\end{center}
\section{Problem: Test7}
The problem inputted by the user is called \textquotedblleft Test7\textquotedblright and consists of maximizing the following fuction:

$Z = x1 \cdot 5.000000 + x2 \cdot 3.000000 + x3 \cdot 1.000000$


Subject to:


$x1 \cdot 1.000000 + x2 \cdot 1.000000 + x3 \cdot 3.000000 \leq 6.000000$

$x1 \cdot 5.000000 + x2 \cdot 3.000000 + x3 \cdot 6.000000 \leq 15.000000$
...
\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        ...
        \hline
        \hline
        0.000& -5.000& -3.000& -1.000& 0.000& 0.000& 0.000\\
        \hline
        0.000& 1.000& 1.000& 3.000& 1.000& 0.000& 6.000\\
        \hline
        0.000& 5.000& 3.000& 6.000& 0.000& 1.000& 15.000\\
        \hline
    \end{tabular}
\end{adjustbox}
...
\subsection{Pivot Table}\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
        \hline
        Z  & $x1$ & $x2$ & $x3$ & $s1$ & $s2$ & b & Fractions\\
        \hline
        \hline
        $0.000$& 0.000& 0.000& 5.000& 0.000& 1.000& 15.000\\
        \hline
        0.000& \cellcolor{LightPink}$0.000$ & 0.400& 1.800& 1.000& -0.200& 3.000& $6.000$ \\
        \hline
        0.000& \cellcolor{KirbyPink}$1.000$ & 0.600& 1.200& 0.000& 0.200& 3.000& \cellcolor{KirbyPink}$3.000$ \\
        \hline
    \end{tabular}
\end{adjustbox}
...
\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        ...
        0.000& 0.000& 0.000& 5.000& 0.000& 1.000& 15.000\\
        \hline
        0.000& 0.000& 0.400& 1.800& 1.000& -0.200& 3.000\\
        \hline
        0.000& 1.000& 0.600& 1.200& 0.000& 0.200& 3.000\\
        \hline
    \end{tabular}
\end{adjustbox}
...
\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        ...
        0.000& -0.000& 0.000& 5.000& 0.000& 1.000& 15.000\\
        \hline
        0.000& -0.667& 0.000& 1.000& 1.000& -0.333& 1.000\\
        \hline
        0.000& 1.667& 1.000& 2.000& 0.000& 0.333& 5.000\\
        \hline
    \end{tabular}
\end{adjustbox}
...
\alpha \cdot 
\begin{bmatrix}
x1 = 3.00 \\ x2 = 0.00 \\ x3 = 0.00 \\ \end{bmatrix}
+ (1 - \alpha) \cdot 
\begin{bmatrix}
x1 = 0.00 \\ x2 = 5.00 \\ x3 = 0.00 \\  \end{bmatrix}
$$
\textbf{Other solutions} 
$$\alpha = 0.25 \Rightarrow 
\begin{bmatrix}
x1 = 0.75 \\ x2 = 3.75 \\ x3 = 0.00 \\ 
\end{bmatrix}
$$

$$\alpha = 0.50 \Rightarrow 
\begin{bmatrix}
x1 = 1.50 \\ x2 = 2.50 \\ x3 = 0.00 \\ 
\end{bmatrix}
$$

$$\alpha = 0.75 \Rightarrow 
\begin{bmatrix}
x1 = 2.25 \\ x2 = 1.25 \\ x3 = 0.00 \\ 
\end{bmatrix}
$$

\subsection{Optimal Solutions}
The final result of maximizing  the given function is 15.000 as a result of setting the variables to the values: 
