...
\end{center}
\section{Problem: Misterio4}
The problem inputted by the user is called \textquotedblleft Misterio4\textquotedblright and consists of maximizing the following fuction:
