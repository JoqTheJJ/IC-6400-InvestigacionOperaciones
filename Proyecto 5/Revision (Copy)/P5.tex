...
\end{center}
\section{Problem: P5}
The problem inputted by the user is called \textquotedblleft P5\textquotedblright and consists of maximizing the following fuction:
...
\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        \hline
        Z  & $x1$ & $x2$ & $x3$ & $S_1$ & $S_2$ & b\\
        \hline
        \hline
        1.000& -5.000& -3.000& -1.000& 0.000& 0.000& 0.000\\
        \hline
...
\subsection{Pivot Table}\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
        \hline
        Z  & $x1$ & $x2$ & $x3$ & $S_1$ & $S_2$ & b & Fractions\\
        \hline
        \hline
        $1.000$& 0.000& 0.000& 5.000& 0.000& 1.000& 15.000\\
        \hline
