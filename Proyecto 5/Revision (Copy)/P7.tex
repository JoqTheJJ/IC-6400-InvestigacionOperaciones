...
\end{center}
\section{Problem: P7}
The problem inputted by the user is called \textquotedblleft P7\textquotedblright and consists of maximizing the following fuction:

$Z = x1 \cdot 0.000000 + x2 \cdot 2.000000$
...
\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|}
        ...
        \hline
        0.000& 1.000& -1.000& 1.000& 0.000& 4.000\\
        \hline
...
\subsection{Pivot Table}\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        ...
        \hline
        0.000& 0.000& \cellcolor{LightPink}$0.000$ & 1.000& 1.000& 5.000& $Invalid$ \\
        \hline
        0.000& -1.000& \cellcolor{KirbyPink}$1.000$ & 0.000& 1.000& 1.000& \cellcolor{KirbyPink}$1.000$ \\
        \hline
    \end{tabular}
\end{adjustbox}
...
In this case it is found in the column 1 where there are no valid fractions:\\
\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        \hline
        Z  & $x1$ & $x2$ & $S_1$ & $S_2$ & b & Fractions\\
        ...
        $1.000$& -2.000& 0.000& 0.000& 2.000& 2.000\\
        \hline
        0.000& \cellcolor{LightPink}$0.000$ & 0.000& 1.000& 1.000& 5.000& $Invalid$ \\
        \hline
        0.000& \cellcolor{LightPink}$-1.000$ & 1.000& 0.000& 1.000& 1.000& $Invalid$ \\
        \hline
    \end{tabular}
\end{adjustbox}
