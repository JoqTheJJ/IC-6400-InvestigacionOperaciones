...
\end{center}
\section{Problem: Misterio2}
The problem inputted by the user is called \textquotedblleft Misterio2\textquotedblright and consists of maximizing the following fuction:
...
$x1 \cdot 1.000000 + x2 \cdot 0.000000 \leq 2.000000$

$x1 \cdot 0.000000 + x2 \cdot 1.000000 \leq 2.000000$
...
\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        ...
        \hline
        0.000& 0.000& 1.000& 0.000& 0.000& 1.000& 2.000\\
        \hline
    \end{tabular}
\end{adjustbox}
...
\subsection{Pivot Table}\begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
        ...
        \hline
        0.000& \cellcolor{LightPink}$0.000$ & -1.000& -1.000& 1.000& 0.000& 0.000& $2.000$ \\
        \hline
        0.000& \cellcolor{LightPink}$0.000$ & 1.000& 0.000& 0.000& 1.000& 2.000& $Invalid$ \\
        \hline
    \end{tabular}
\end{adjustbox}
